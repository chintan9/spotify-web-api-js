...
describe('Basic tests', function() {
  ...
  beforeEach(function() {
    ...
    that.xhr.onCreate = function(xhr) { that.requests.push(xhr); };
  });

  afterEach(function() { that.xhr.restore(); });
  ...
  describe('Using callbacks',
           function() {
             ...
             it("should get an albums's tracks", function() {
               ...
               expect(callback.calledWith(null, fixtures.album_tracks))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe(
             ...
             it("should get an artist's albums", function() {
               ...
               expect(callback.calledWith(null, fixtures.artist_albums))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe(
             ...
             it("should get 2 artist's albums", function() {
               var callback = sinon.spy();
               var api = new SpotifyWebApi();
               api.getArtistAlbums('5YyScSZOuBHpoFhGvHFedc', {limit : 2},
                                   callback);
               that.requests[0].respond(
                   200, {'Content-Type' : 'application/json'},
                   JSON.stringify(fixtures.artist_albums_limit_2));
               expect(callback.calledWith(null, fixtures.artist_albums_limit_2))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe(
             ...
             it("should get an artist's top tracks", function() {
               ...
               expect(callback.calledWith(null, fixtures.artist_top_tracks))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe(
             ...
             it('should search for albums', function() {
               ...
               expect(callback.calledWith(null, fixtures.search_album))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe(
             ...
             it('should search for artists', function() {
               ...
               expect(callback.calledWith(null, fixtures.search_artist))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe(
             ...
             it('should search for tracks', function() {
               ...
               expect(callback.calledWith(null, fixtures.search_track))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe(
             ...
             it('should search for playlists', function() {
               ...
               expect(callback.calledWith(null, fixtures.search_playlist))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe(
             ...
             it('should search for shows', function() {
               ...
               expect(callback.calledWith(null, fixtures.search_show))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe(
             ...
             it('should search for episodes', function() {
               var callback = sinon.spy();
               var api = new SpotifyWebApi();
               api.searchEpisodes('web performance', {offset : 0, limit : 1},
                                  callback);
               that.requests[0].respond(
                   200, {'Content-Type' : 'application/json'},
                   JSON.stringify(fixtures.search_episode));
               expect(callback.calledWith(null, fixtures.search_episode))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe(
             ...
             it("should get a show's episodes", function() {
               var callback = sinon.spy();
               var api = new SpotifyWebApi();
               api.getShowEpisodes('7qV2tMPbnZu18p2h0w6vvR',
                                   {offset : 0, limit : 2}, callback);
               that.requests[0].respond(200,
                                        {'Content-Type' : 'application/json'},
                                        JSON.stringify(fixtures.show_episodes));
               expect(callback.calledWith(null, fixtures.show_episodes))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe(
             ...
             it('should get several episodes', function() {
               ...
               expect(callback.calledWith(null, fixtures.episodes))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe(
             ...
             it("should get user's saved shows", function() {
               ...
               expect(callback.calledWith(null, fixtures.user_saved_shows))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe(
             ...
             it("should add shows to user's saved shows", function() {
               ...
               api.addToMySavedShows(
                   [
                     '5AvwZVawapvyhJUIx71pdJ', '6ups0LMt1G8n81XLlkbsPo',
               ...
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe('https://api.spotify.com/v1/me/shows');
             ...
             it("should check if a show is in the user's saved shows", function() {
               ...
               expect(callback.calledWith(null, [ true, true, false ]))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe(
             ...
             it('should get a track using a token', function() {
               ...
               expect(that.requests[0].url)
                   .toBe(
                       'https://api.spotify.com/v1/tracks/3Qm86XLflmIXVm1wcwkgDK');
               expect(that.requests[0].requestHeaders.Authorization)
             ...
             it('should return an error when looking up a wrong id',
                function() {
                  ...
                  expect(callback.calledWith(sinon.match(Error), null))
                      .toBeTruthy();
                  expect(that.requests.length).toBe(1);
                  expect(that.requests[0].url)
                      .toBe('https://api.spotify.com/v1/albums/asdyi1uy');
                });
             ...
             it('should get information about a user', function() {
               ...
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe('https://api.spotify.com/v1/users/jmperezperez');
             });
             ...
             it('should get information about a user with a "#" character and encode it properly',
                function() {
                  ...
                  expect(that.requests.length).toBe(1);
                  expect(that.requests[0].url)
                      .toBe('https://api.spotify.com/v1/users/%23matze23');
                });
             ...
             it('should get information about the current logged in user',
                function() {
                  ...
                  expect(that.requests.length).toBe(1);
                  expect(that.requests[0].url)
                      .toBe('https://api.spotify.com/v1/me');
                });
             ...
             it("should get user's saved tracks", function() {
               ...
               expect(callback.calledWith(null, fixtures.user_saved_tracks))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe('https://api.spotify.com/v1/me/tracks');
             });
             ...
             it("should check if a track is in the user's saved tracks",
                function() {
                  ...
                  expect(callback.calledWith(null, [ true, true ]))
                      .toBeTruthy();
                  expect(that.requests.length).toBe(1);
                  expect(that.requests[0].url)
                      .toBe(
             ...
             it("should get user's saved albums", function() {
               ...
               expect(callback.calledWith(null, fixtures.user_saved_albums))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe('https://api.spotify.com/v1/me/albums');
             });
             ...
             it("should get user's top artists", function() {
               ...
               expect(callback.calledWith(null, fixtures.user_top_artists))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe('https://api.spotify.com/v1/me/top/artists?limit=5');
             });
             ...
             it("should get user's top tracks", function() {
               ...
               expect(callback.calledWith(null, fixtures.user_top_tracks))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe('https://api.spotify.com/v1/me/top/tracks?limit=5');
             });
             ...
             it("should get user's playlists", function() {
               ...
               expect(callback.calledWith(null, fixtures.user_playlists))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe('https://api.spotify.com/v1/users/a_user/playlists');
             });
             ...
             it("should get current user's playlists", function() {
               ...
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe('https://api.spotify.com/v1/me/playlists');
             });
             ...
             it('should get a playlist', function() {
               ...
               expect(callback.calledWith(null, fixtures.playlist))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe(
             ...
             it('should get the tracks of a playlist', function() {
               ...
               expect(callback.calledWith(null, fixtures.playlist_tracks))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe(
             ...
             it('should get cover image of a playlist', function() {
               ...
               expect(callback.calledWith(null, fixtures.playlist_cover_image))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe(
             ...
             it('should create a playlist', function() {
               ...
               var api = new SpotifyWebApi();
               api.setAccessToken('<example_access_token>');
               api.createPlaylist('a_user', {name : 'A name for the playlist'},
                                  callback);
               that.requests[0].respond(
                   200, {'Content-Type' : 'application/json'},
                   JSON.stringify(fixtures.user_new_playlist));
               expect(callback.calledWith(null, fixtures.user_new_playlist))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe('https://api.spotify.com/v1/users/a_user/playlists');
             ...
             it("should update a playlist's details", function() {
               ...
               api.changePlaylistDetails(
                   ...
                   {name : 'A NEW name for the playlist', public : false},
                   callback);
               that.requests[0].respond(
                   200, {'Content-Type' : 'application/json'}, '');
               expect(callback.calledWith(null, '')).toBeTruthy();
             ...
             it('should add tracks to a playlist', function() {
               ...
               api.addTracksToPlaylist(
                   '7Kud0O2IdWLbEGgvBkW9di',
                   [ 'spotify:track:2Oehrcv4Kov0SuIgWyQY9e' ], callback);
               that.requests[0].respond(
             ...
             it('should add tracks to a playlist, specifying position', function() {
               ...
               api.addTracksToPlaylist(
                   '7Kud0O2IdWLbEGgvBkW9di',
                   [ 'spotify:track:2Oehrcv4Kov0SuIgWyQY9e' ], {position : 0},
                   callback);
               that.requests[0].respond(
                   201, {'Content-Type' : 'application/json'}, '');
               expect(callback.calledWith(null, '')).toBeTruthy();
             ...
             it('should remove tracks from a playlist using a snapshot id',
                function() {
                  ...
                  api.removeTracksFromPlaylistWithSnapshotId(
                      '7Kud0O2IdWLbEGgvBkW9di',
                      [ 'spotify:track:2Oehrcv4Kov0SuIgWyQY9e' ], 'AsNaPsHoTiD',
                      callback);
                  that.requests[0].respond(
                      200, {'Content-Type' : 'application/json'}, '');
                  expect(callback.calledWith(null, '')).toBeTruthy();
             ...
             it('should remove tracks from a playlist specifying just their positions and snapshot id',
                function() {
                  ...
                  api.removeTracksFromPlaylistInPositions(
                      '7Kud0O2IdWLbEGgvBkW9di', [ 0, 1, 3, 9 ], 'AsNaPsHoTiD',
                      callback);
                  that.requests[0].respond(
                      200, {'Content-Type' : 'application/json'}, '');
                  expect(callback.calledWith(null, '')).toBeTruthy();
             ...
             it('should reorder tracks in a playlist', function() {
               ...
               var api = new SpotifyWebApi();
               api.setAccessToken('<example_access_token>');
               api.reorderTracksInPlaylist('7Kud0O2IdWLbEGgvBkW9di', 1, 3,
                                           callback);
               that.requests[0].respond(
                   200, {'Content-Type' : 'application/json'},
               ...
               expect(that.requests[0].method).toBe('PUT');
               expect(that.requests[0].status).toBe(200);
               expect(that.requests[0].requestBody)
                   .toBe(JSON.stringify({range_start : 1, insert_before : 3}));
             });
             ...
             it('should upload a custom playlist cover image', function() {
               ...
               api.uploadCustomPlaylistCoverImage(
                   '7Kud0O2IdWLbEGgvBkW9di', imageDataWithEncoding, callback);
               ...
               expect(that.requests[0].requestHeaders['Content-Type'].includes(
                          'image/jpeg'))
                   .toBe(true);
               expect(that.requests[0].requestBody)
                   .toBe(imageDataWithoutEncoding);
             });
             ...
             it('should get featured playlists', function() {
               ...
               expect(callback.calledWith(null, fixtures.featured_playlists))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe(
             ...
             it('should get new releases', function() {
               ...
               expect(callback.calledWith(null, fixtures.new_releases))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe(
             ...
             it('should get list of categories', function() {
               var callback = sinon.spy();
               var api = new SpotifyWebApi();
               api.getCategories({locale : 'sv_SE', country : 'SE'}, callback);
               that.requests[0].respond(
                   200, {'Content-Type' : 'application/json'},
                   JSON.stringify(fixtures.browse_categories));
               expect(callback.calledWith(null, fixtures.browse_categories))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe(
             ...
             it('should get the dinner category', function() {
               var callback = sinon.spy();
               var api = new SpotifyWebApi();
               api.getCategory('dinner', {locale : 'sv_SE', country : 'SE'},
                               callback);
               that.requests[0].respond(200,
                                        {'Content-Type' : 'application/json'},
                                        JSON.stringify(fixtures.category));
               expect(callback.calledWith(null, fixtures.category))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe(
             ...
             it('should get the dinner category playlists', function() {
               var callback = sinon.spy();
               var api = new SpotifyWebApi();
               api.getCategoryPlaylists('dinner', {country : 'SE'}, callback);
               that.requests[0].respond(
                   200, {'Content-Type' : 'application/json'},
                   JSON.stringify(fixtures.category_playlists));
               expect(callback.calledWith(null, fixtures.category_playlists))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe(
             ...
             it('should check whether a user is following several other users',
                function() {
                  ...
                  expect(callback.calledWith(
                             null, fixtures.follow_is_following_users))
                      .toBeTruthy();
                  expect(that.requests.length).toBe(1);
                  expect(that.requests[0].url)
                      .toBe(
             ...
             it('should check whether a user is following several other artists',
                function() {
                  ...
                  expect(callback.calledWith(
                             null, fixtures.follow_is_following_artists))
                      .toBeTruthy();
                  expect(that.requests.length).toBe(1);
                  expect(that.requests[0].url)
                      .toBe(
             ...
             it('should follow a playlist privately', function() {
               var callback = sinon.spy();
               var api = new SpotifyWebApi();
               api.followPlaylist('2ujjMpFriZ2nayLmrD1Jgl', {public : false},
                                  callback);
               that.requests[0].respond(200);
               expect(that.requests[0].method).toBe('PUT');
               expect(callback.calledWith(null, '')).toBeTruthy();
             ...
             it('should check whether users are following a playlist', function() {
               var callback = sinon.spy();
               var api = new SpotifyWebApi();
               api.areFollowingPlaylist('2ujjMpFriZ2nayLmrD1Jgl',
                                        [ 'userid01', 'userid02' ], callback);
               that.requests[0].respond(
                   200, {'Content-Type' : 'application/json'},
                   JSON.stringify(fixtures.follow_are_following_playlist));
               expect(that.requests[0].method).toBe('GET');
               expect(callback.calledWith(
                          null, fixtures.follow_are_following_playlist))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe(
             ...
             it('should get followed artists', function() {
               ...
               expect(that.requests[0].method).toBe('GET');
               expect(callback.calledWith(null, fixtures.followed_artists))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe('https://api.spotify.com/v1/me/following?type=artist');
             });
             ...
             it('should get the audio features for a track', function() {
               ...
               var result = api.getAudioFeaturesForTrack(
                   '3Qm86XLflmIXVm1wcwkgDK', callback);
               that.requests[0].respond(
                   200, {'Content-Type' : 'application/json'},
                   JSON.stringify(fixtures.track_audio_features));
               expect(that.requests[0].method).toBe('GET');
               expect(callback.calledWith(null, fixtures.track_audio_features))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe(
             ...
             it('should get the audio features for several tracks', function() {
               ...
               expect(that.requests[0].method).toBe('GET');
               expect(callback.calledWith(null, fixtures.tracks_audio_features))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe(
             ...
             it('should get the audio analysis for a track', function() {
               ...
               expect(that.requests[0].method).toBe('GET');
               expect(callback.calledWith(null, fixtures.track_audio_analysis))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe(
             ...
             it('should get recommendations', function() {
               ...
               expect(that.requests[0].method).toBe('GET');
               expect(callback.calledWith(null, fixtures.recommendations))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe(
             ...
             it('should get available genre seeds', function() {
               ...
               expect(that.requests[0].method).toBe('GET');
               expect(callback.calledWith(null, fixtures.genre_seeds))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe(
             ...
             it('should get available devices', function() {
               ...
               expect(that.requests[0].method).toBe('GET');
               expect(callback.calledWith(null, fixtures.available_devices))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe('https://api.spotify.com/v1/me/player/devices');
             });
             ...
             it('should get current playback', function() {
               ...
               expect(that.requests[0].method).toBe('GET');
               expect(callback.calledWith(null, fixtures.current_playback))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe('https://api.spotify.com/v1/me/player');
             });
             ...
             it('should get current playing track', function() {
               ...
               expect(that.requests[0].method).toBe('GET');
               expect(callback.calledWith(null, fixtures.current_playing_track))
                   .toBeTruthy();
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe(
             ...
             it('should play', function() {
               ...
               expect(that.requests.length).toBe(1);
               expect(that.requests[0].url)
                   .toBe('https://api.spotify.com/v1/me/player/play');
             });
  ...
  describe('Using Promises/A+ through Q.js', function() {
    it('should get a track and use the provided promise implementation',
       function() {
         ...
         return result.then(function(
             data) { expect(data).toEqual(fixtures.track); });
       });
    ...
    it('should return an error when looking up a wrong id and use the provided promise implementation',
       function(done) {
         var api = new SpotifyWebApi();
         api.setPromiseImplementation(Q);
         var result = api.getAlbum('asdyi1uy');
         that.requests[0].respond(404, {'Content-Type' : 'application/json'},
                                  JSON.stringify(fixtures.error_id_not_found));
  ...
  describe(
      'Using Promises/A+ through a not supported promise implementation',
      function() {
